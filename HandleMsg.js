            ...
            if (isOwnerBot) {
                await aruga.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await aruga.sendText(chekgrup.id, `Hai minna~, Im F-BOT. To find out the commands on this Bot type ${prefix}menu`)
                      })
            } else {
